...
const FormlessMaterial = shaderMaterial(
  ...
  varying vec2 vUv;
  void main() {
    vec2 displacedUv = vUv + pnoise4(vec4(vUv * 9.0, 1.0, time * 0.05));
    float strength = pnoise4(vec4(displacedUv * 1.0, -1.0, time * 0.2));
...
function ShaderPlane() {
  ...
  useFrame((state, delta) => (ref.current.color += delta))
  return (
